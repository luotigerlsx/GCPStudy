...
def main():
    ...
    parser.add_argument(
        ...
        default='/Users/luoshixin/Downloads/data')
    parser.add_argument(
        '--working_dir',
        help='optional, path to directory to hold transformed data',
        default='/Users/luoshixin/Personal/GCPStudy/src/tensorflow/tftransform/tmp')
    ...
    train_data_file = os.path.join(args.input_data_dir, 'adult.data.csv')
    test_data_file = os.path.join(args.input_data_dir, 'adult.test.csv')
